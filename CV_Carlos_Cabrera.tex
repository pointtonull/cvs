...
%% % \cvline{hobby 1}{\small Descripción}
    \cvline{Resume}{This is not an exhaustive enumeration. You can email me to request a longer version}  % version:short
